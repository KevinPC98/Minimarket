 ...
 * @author DIEGO
 */
public class frmMostrarProductos extends BaseInterenalFrame<Interface.presentador> implements Interface.vista{
    String cuerpo[][];
    ...
    public void mostrarTabla(String cuerpo[][]){
        String [] cabecera= {"IDPRODUCTO","NOMBRE","DESCRIPCION","NROLOTE","FECHAVENCIMIENTO","CANTIDAD","STOCK"};
